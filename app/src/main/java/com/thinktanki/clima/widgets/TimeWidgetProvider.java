package com.thinktanki.clima.widgets;
...
import com.thinktanki.clima.BuildConfig;
import com.thinktanki.clima.activities.MainActivity;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "com.thinktanki.forecastie.UPDATE_TIME";
